...
import thedrake.ui.view.EndGameController;
...
public class Main extends Application {
    ...
    public void start(Stage stage) throws Exception {
        AnchorPane mainMenu = FXMLLoader.load(getClass().getResource("view/sample.fxml"));
        ...
        endScene.getStylesheets().add("thedrake/ui/view/style.css");
